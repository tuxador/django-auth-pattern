...
\setupletteroptions[language=netherlands,
 ...
 \defineletterelement[layer][foot][example]%
   ...
   \startletter[
       ...
       subject={patient{% if patient.gender == 'F' %}e{% endif %}: {{ patiet.name }}]
   ...
   {% else %}Cher confrère, chère consoeur,

   le bilan cardiovasculaire {% if patient.gender == 'F' %}de la patiente{% else %}du patient {\sc {{ patient.name }} } âgée de 67 ans, hypertendue, candidate à une chirurgie de goitre est revenu  {\bf satisfaisant}, hormis des chiffres tensionnels diastoliques limite.
   L'ECG et l'échocoeur sont en faveur d'une cardiopathie hypertensive stable sous traitement.

J'ai décidé de switcher son traitement anti HTA par du Lopressor 200mg.

Il n'y a donc pas contre-indications d'ordre cardiologiques à son intervention.

Je vous remercie pour votre confiance, et me mets à votre disposition si d'autres informations vous semblent utiles.
