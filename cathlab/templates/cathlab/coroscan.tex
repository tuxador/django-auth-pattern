...
%\placetable[none]{}
 {\bTABLE[setups={table:style, table:width}]
   ...
   \eTR
\bTR
   \bTD épreuve d'effort positive \eTD
   \bTD Dr Yahyaoui\eTD
   \bTD CNAS \eTD
   \eTR
\eTABLE} 
...
%\startitem . \stopitem
%\startitem  Thrombose porte \stopitem
%\stopitemize
%
%startitemize[2,columns,two,packed]
%  \startitem Avlocardyl 160. \stopitem
%    \startitem Innohep 14000. \stopitem
...
%    Pas d'hypertrophie
%  \stopitem
% \startitem   Absence de troubles de la repolarisation.\stopitem
%  \stopitemize
%\\
%\starttabulate[|w(0.2\textwidth)B|p|]
%\NC Auscultation\NC  normale , rythme régulier à {\bf 70bpm}\NR
%\NC ECG\NC  BBG complet \\
%    troubles de la repolarisation secondaires \NR
%\stoptabulate
\startitemize[2,columns,two,packed]
  \startitem mode d'acquisition: hélicoïdal \stopitem
  \startitem épaisseur de coupe: 0.9mm\stopitem
  \startitem kVp: 120kVp \stopitem
  \startitem mAs: 800mAs\stopitem
  \startitem phases: 35-40-50-75-80
\stopitem
  \startitem durée d'esposition 2100msec
\stopitem
\stopitemize
...
Bien développé, indemne de lésions.
\stopdescription
\startdescription{IVA}
Athéromateuse, sténose à 50\% à la naissance de l'IVA II, bon lit d'aval.
\stopdescription
\startdescription{Cx}
Dominante, indemne de lésions.
\stopdescription
\startdescription{CD}
Dominée, athéromateuse. Lésion paraissant intermédiaire de la CD2.
\stopdescription
...
\startalerttext
Sténose à 50\% de l'IVA II. Lésion paraissant intermédiaire de la CD2. 
\stopalerttext
