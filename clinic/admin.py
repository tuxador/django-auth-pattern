...
class ConsultationAdmin(admin.ModelAdmin, ExportCsvMixin):
...
class AdmissionAdmin(admin.ModelAdmin, ExportCsvMixin):
...
class ReceptionAdmin(admin.ModelAdmin, ExportCsvMixin):
...
class StressAdmin(admin.ModelAdmin, ExportCsvMixin):
...
class FicheTechniqueAdmin(admin.ModelAdmin, ExportCsvMixin):
